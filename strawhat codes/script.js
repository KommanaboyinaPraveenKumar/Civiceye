...
function login() {
    ...
    } else if (username === 'official' && password === 'password') {
...
function showCitizenDashboard() {
    document.getElementById('mainLoginSection').style.display = 'none';
    document.getElementById('citizenDashboard').style.display = 'block';

    // Set user info (replace with actual user data)
    document.getElementById('citizenName').innerText = 'John Doe';
    document.getElementById('citizenEmail').innerText = 'john.doe@example.com';
    document.getElementById('citizenPhone').innerText = '123-456-7890';
    document.getElementById('citizenAadhar').innerText = '1234-5678-9012';
    document.getElementById('citizenUsername').innerText = 'citizen';
}

function showOfficialDashboard() {
    document.getElementById('mainLoginSection').style.display = 'none';
    document.getElementById('officialDashboard').style.display = 'block';

    // Set user info (replace with actual user data)
    document.getElementById('officialName').innerText = 'Jane Smith';
    document.getElementById('officialEmail').innerText = 'jane.smith@gov.com';
    document.getElementById('officialPhone').innerText = '987-654-3210';
    document.getElementById('officialDesignation').innerText = 'Manager';
    document.getElementById('officialIdDisplay').innerText = 'OFF123';
    document.getElementById('officialUsername').innerText = 'official';
}
